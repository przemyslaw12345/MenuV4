...
internal class CreatingToDatabase : ICreatingToDatabase
{
	...
	private EventHandler _addedItem;
	public CreatingToDatabase(MenuDbContext menuDbContext,
		 EventHandler addedItem)
    {
	...
	private void AddMethod(string optionToAddSelected)
	{
		...
		switch (optionToAddSelected)
		{
			case "drink":
				...
				_menuDbContext.Drinks.Add(newDrinkToAdd);
				_addedItem.Invoke(this, newDrinkToAdd);
				break;
			case "meal":
				...
				_menuDbContext.Meals.Add(newMealToAdd);
				AddedItem.Invoke(this, newMealToAdd);
				break;
		}
